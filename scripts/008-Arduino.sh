...
# Install avrdude-rpi
cp avrdude-rpi/autoreset2560 ~/arduino-1.6.10/hardware/tools/avr/bin/
cp avrdude-rpi/autoreset328 ~/arduino-1.6.10/hardware/tools/avr/bin/
cp avrdude-rpi/avrdude-autoreset ~/arduino-1.6.10/hardware/tools/avr/bin/
